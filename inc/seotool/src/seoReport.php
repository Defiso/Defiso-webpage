...
class seoReport{
  ...
  public $senderEmail = 'noreply@defiso.se';
  public $senderName = 'Defiso Media';
  ...
  private function SetMailSettings(){
    ...
    $this->mailObject->Host = 'mailcluster.loopia.se';         // Specify main and backup SMTP servers
    $this->mailObject->SMTPAuth = true;                               // Enable SMTP authentication
    $this->mailObject->Username = 'noreply@defiso.se';                 // SMTP username
    $this->mailObject->Password = 'Svarsmejl16';                           // SMTP password
